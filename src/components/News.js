...
export class News extends Component {
  ...
  constructor(props){
    super(props);
    console.log("Hello to the news monkey application");
    this.state={
  ...
  // async componentDidMount(){
   // let url='https://newsapi.org/v2/top-headlines?sources=techcrunch&apiKey=63b5f2c6ef974957a918a67c29fc0652';
  ...
  //handlePrevClick= async()=>{
   //let url='https://newsapi.org/v2/top-headlines?sources=techcrunch&apiKey=63b5f2c6ef974957a918a67c29fc0652&page=${this.state.page - 1} &pageSize=3';
   //let data=await fetch(url);
   //let parsedData=await data.json();
   //console.log(parsedData);
   //this.setState({
  ...
  render() {
    return (
      <div className='container my-3 '>
        <h2 >NewsHeadlines-Get latest news here!</h2>
